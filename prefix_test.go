...
func TestReadPrefixedBytes(t *testing.T) {
	...
	// standard
	_, err := b.Write(append(EncUint64(3), "foo"...))
	if err != nil {
		t.Error(err)
	}
...
func TestReadObject(t *testing.T) {
	...
	_, err = b.WriteString("foo") // strings need an additional length prefix
	if err != nil {
		t.Error(err)
	}
